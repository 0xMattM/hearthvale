...
/**
 * CL78.1 — Min HUD / interact prompts still green.
 * Choice: assert-only walk-up prompts + closed craft/notice (parity with CL66.2; no invent panels).
 */
describe("CityLands CL78.1 min HUD / interact prompts still green", () => {
