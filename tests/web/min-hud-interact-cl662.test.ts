...
/**
 * CL66.2 — Min HUD / interact prompts still green.
 * Choice: assert-only walk-up prompts + closed craft/notice (CL46.2 / CL50.1 / CL54.1).
 */
describe("CityLands CL66.2 min HUD / interact prompts still green", () => {
