...
/**
 * CL90.1 — Notice tip / scarce_stations fidelity still green.
 * Choice: assert-only stable ids + scarce vs unlimited copy (parity with CL82.1; no invent).
 */
describe("CityLands CL90.1 Notice tip / scarce_stations fidelity still green", () => {
  it("keeps travel / scarce / warrior tip ids and scarce vs land copy (happy)", () => {
    ...
    expect(scarce.body.toLowerCase()).toMatch(
      /kitchen|workshop|forge|mill|loom|dock|tree|ore|crop/,
    );
