...
/**
 * CL82.1 — Notice tip / scarce_stations fidelity still green.
 * Choice: assert-only stable ids + scarce vs unlimited copy (parity with CL70.1; no invent).
 */
describe("CityLands CL82.1 Notice tip / scarce_stations fidelity still green", () => {
