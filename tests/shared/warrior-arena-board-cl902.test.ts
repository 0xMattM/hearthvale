...
/**
 * CL90.2 — Warrior arena optional still green.
 * Choice: assert-only plaque + tip fidelity (parity with CL82.2; no combat balance invent).
 */
describe("CityLands CL90.2 Warrior arena optional still green", () => {
