...
/**
 * CL54.2 — Warrior arena board / tip still optional; no balance invent; off homestead.
 * Choice: assert-only plaque + tip fidelity over inventing combat ladders.
 */
describe("CityLands CL54.2 Warrior arena board optional fidelity", () => {
  it("keeps plaque optional / no-ladder and tip optional (happy)", () => {
    ...
    expect(tip!.body.toLowerCase()).toMatch(/profession ladder|no combat/);
  ...
  it("keeps arena stub copy without balance numbers (edge)", () => {
