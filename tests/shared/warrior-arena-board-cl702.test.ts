...
/**
 * CL70.2 — Warrior arena board optional still green.
 * Choice: assert-only plaque + tip fidelity; no combat balance invent.
 */
describe("CityLands CL70.2 Warrior arena board optional still green", () => {
